...
import { ACCESS_TOKEN, RoutePath } from '@vmware/constants';
import { SignInPayload, SignInResponse, User } from '@vmware/api-interfaces';
  ...
  const signIn = useCallback(
    async (payload: SignInPayload) => {
      try {
        ...
        const defaultPath = ['PROVIDER_ADMIN'].includes(session.user.role)
          ? RoutePath.provider
